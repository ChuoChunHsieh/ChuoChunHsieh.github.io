<template> 
    <div id="container" class="H">

        <section class="open-book">
            <header>
                <h1>國立清華大學教育與學習科技系.謝卓君 副教授</h1>
                <h6>
                    <!-- <button type="submit" 
                            class="py-2 px-4 text-slate-300 border border-transparent text-sm font-medium rounded-full bg-indigo-600 
                            hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                
                    
                    </button>   -->

                    <button onclick="location.href='introList_CASE1'"  class="bg-orange-500 hover:bg-orange-400 text-white font-bold py-1 px-2  mx-2 animate-bounce  hover:border-orange-500 rounded">
                    抽 一文章
                    </button> 
            ...
            Chuo-Chun Jean Hsieh </h6>
            </header>
            <article>
                <h2 class="chapter-title">hybird educational management</h2>
                <p>
                    Sublime Text 2 was opened and a new document was created. "I love this time of year," Erin gleefully thought to herself.
                </p>
                <p>
                    The "time of year" that is being referenced relates to Erin's job when the pile of projects temporarily slow down. This doesn't happen to just her. The reduction of work  
                </p>
                
                <p>
                    T ked pens. She envied the skills of those using compilers she has yet to dabble in. Then she put together a list of what she would like to achieve.
                </p>
                <p>
                    E razy, but what if I develop a section of text that looks like a book?"
                </p>
                
                <dl>
                    <dt><strong>Policy Borrowing</strong></dt>
                    <dd>
                        <em>noun</em><br>
                ...
                <v-card-title>最新訊息</v-card-title> 
                <p>
                ...
                <v-card-title>個人簡介</v-card-title> 
                    ...
                    <v-card-title>熱衷議題</v-card-title> 
                    <v-card-text>  
